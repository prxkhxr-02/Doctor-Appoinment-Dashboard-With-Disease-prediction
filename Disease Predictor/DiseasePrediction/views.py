...
def get_disease_data(name, disease):
    ...
    data = {
        "Name": name,
        "prediction": disease,
        "description": disc["Description"].values[0],
...
def index(request):
    if request.method == 'POST':
        ...
        prediction = algo_predict(choice_input)
        dict_result = get_disease_data(name, prediction[0])
        return render(request, 'report.html', dict_result)
